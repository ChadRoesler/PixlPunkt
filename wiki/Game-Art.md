...
2. Choose layout:
   - **Horizontal strip** - All frames in row
...
PixlPunkt exports to Tiled-compatible formats:
- TSX tile sets
- Import/export TMX maps
...
- [[Animation Workflow|Animation-Workflow]] - Animation techniques
