...
namespace PixlPunkt.PluginSdk.Imaging
{
    ...
    public sealed class PixelSurface
    {
        ...
        /// <summary>
        /// Occurs after any pixel mutation operation.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// <remarks>
        /// This method efficiently fills all pixels with the specified color and raises
        /// the <see cref="PixelsChanged"/> event once after completion.
        /// </remarks>
