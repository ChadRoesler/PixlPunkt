...
namespace PixlPunkt.PluginSdk.Settings
{
    ...
    /// </para>
    /// <code>
    /// public sealed class BrushToolSettings : ToolSettingsBase, IStrokeSettings
    /// {
    ///     public override Icon Icon => Icon.Pen;
    ///     public override string DisplayName => "Brush";
    ///     public override string Description => "Paint with solid colors";
    ...
    public abstract class ToolSettingsBase
    {
        ...
        /// host application converts to UI controls.
        /// </returns>
        /// <remarks>
        /// <para>
