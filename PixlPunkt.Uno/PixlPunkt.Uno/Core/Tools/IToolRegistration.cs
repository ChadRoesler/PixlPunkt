...
namespace PixlPunkt.Uno.Core.Tools
{
    ...
    /// </para>
    /// <para>
    /// Each tool category has a specific implementation:
    /// </para>
    /// <list type="bullet">
    /// <item><see cref="ToolRegistration"/> - Brush tools with <see cref="IStrokePainter"/></item>
    /// <item><see cref="SelectionToolRegistration"/> - Selection tools with <see cref="ISelectionTool"/></item>
    /// </list>
    /// <para>
    ...
    public interface IToolRegistration
    {
        ...
        /// <see cref="IBrushLikeSettings"/> for brush-style tools.
        /// </remarks>
