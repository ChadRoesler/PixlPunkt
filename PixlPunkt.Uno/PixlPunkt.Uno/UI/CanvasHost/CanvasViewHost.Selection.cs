...
using PixlPunkt.Uno.UI.CanvasHost.Selection;
using Windows.Foundation;
using Windows.Graphics;
using Windows.System;
using Windows.UI.Core;
using static PixlPunkt.Uno.Core.Helpers.GraphicsStructHelper;
using RotHandle = PixlPunkt.Uno.UI.CanvasHost.Selection.SelectionSubsystem.RotHandle;
// Alias for subsystem types
using SelDrag = PixlPunkt.Uno.UI.CanvasHost.Selection.SelectionSubsystem.SelDrag;
using SelectionState = PixlPunkt.Uno.UI.CanvasHost.Selection.SelectionSubsystem.SelectionState;
using SelHandle = PixlPunkt.Uno.UI.CanvasHost.Selection.SelectionSubsystem.SelHandle;
