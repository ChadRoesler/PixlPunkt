...
using PixlPunkt.Uno.UI.Dialogs.Import;
    ...
    public sealed partial class PixlPunktMainWindow : Window
    {
        ...
        private async void File_Import_SubRoutine(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var reel = PixlPunkt.Uno.Core.Animation.TileAnimationReelIO.Load(file.Path);
                ...
                var subRoutine = new PixlPunkt.Uno.Core.Animation.AnimationSubRoutine
                {
